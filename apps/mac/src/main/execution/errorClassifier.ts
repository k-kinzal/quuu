...
// The default patterns are read by the UI too (Settings > Agents), so they live in shared
...
/** Classification -> run status. Runner and the post-restart settling share one table. */
