...
export const en = {
  ...
  tasks: {
    ...
    cliUnavailable: 'This task belongs to {{cli}}, and no {{cli}} agent can take it',
    pickUnavailable: 'This task is set to {{agent}}, which is disabled',
  ...
  resolveFailure: {
    ...
    'pick-unavailable': 'The agent this task is set to is disabled',
    'other-cli': "No agent of this task's CLI is enabled",
  ...
  scheduler: {
    ...
    ownerCoolingUntil: 'The {{owner}} that opened this session is in Limit cooldown (back at {{time}})',
