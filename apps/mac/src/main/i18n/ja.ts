...
export const ja: typeof en = {
  ...
  tasks: {
    ...
    cliUnavailable: 'このタスクは {{cli}} のものですが、引き受けられる {{cli}} のエージェントがありません',
    pickUnavailable: 'このタスクに指定された {{agent}} が無効化されています',
  ...
  resolveFailure: {
    ...
    'pick-unavailable': 'このタスクに指定されたエージェントが無効化されています',
    'other-cli': 'このタスクの CLI のエージェントが有効になっていません',
  ...
  scheduler: {
    ...
    ownerCoolingUntil: 'セッションを開いた {{owner}} が Limit クールダウン中です（{{time}} 復帰）',
