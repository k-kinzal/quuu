...
const labels: OperationLabels<QuuuApi> = {
  ...
  agents: { defaults: t('operationFailure.op.agents.defaults'), create: t('operationFailure.op.agents.create'), update: t('operationFailure.op.agents.update'), duplicate: t('operationFailure.op.agents.duplicate'), remove: t('operationFailure.op.agents.remove') },
