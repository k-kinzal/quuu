 ...
 */
export const AppCommandSchema = z.union([z.literal('task.new'), z.literal('task.addAfter'), z.literal('task.addBefore'), z.literal('task.runNow'), z.literal('task.markDone'), z.literal('task.sendBack'), z.literal('task.archive'), z.literal('task.delete'), z.literal('task.close'), z.literal('task.open'), z.literal('task.setPriority'), z.literal('task.openTerminal'), z.literal('task.resumeTerminal'), z.literal('task.openEditor'), z.literal('view.all'), z.literal('view.review'), z.literal('view.settings'), z.literal('view.palette'), z.literal('view.project'), z.literal('view.search'), z.literal('panel.rail'), z.literal('panel.list'), z.literal('panel.inspector'), z.literal('project.settings'), z.literal('project.add'), z.literal('focus.next'), z.literal('focus.prev'), z.literal('menu.context')])
